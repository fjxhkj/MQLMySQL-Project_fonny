...
void OnStart()
{
  ...
  INI = TerminalInfoString(TERMINAL_DATA_PATH) + "\\MQL4\\Scripts\\MySQL\\MyConnection.ini";
  ...
  if (Cursor1 >= 0)
  {
    Print("Cursor 1 was opened.");
  }
  else
  {
    Print("Cursor 1 failed. Error: ", MySqlErrorDescription);
  }
  Cursor2 = MySqlCursorOpen(DB, Query);
  if (Cursor2 >= 0)
  {
    Print("Cursor 2 was opened.");
  }
  else
  {
    Print("Cursor 2 failed. Error: ", MySqlErrorDescription);
  }
  Cursor3 = MySqlCursorOpen(DB, Query);
  if (Cursor3 >= 0)
  {
    Print("Cursor 3 was opened.");
  }
  else
  {
    Print("Cursor 3 failed. Error: ", MySqlErrorDescription);
  }
  Cursor4 = MySqlCursorOpen(DB, Query);
  if (Cursor4 >= 0)
  {
    Print("Cursor 4 was opened.");
  }
  else
  {
    Print("Cursor 4 failed. Error: ", MySqlErrorDescription);
  }
